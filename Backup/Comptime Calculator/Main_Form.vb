...
'Updated Last           March 2014

'Update Notes:          Added emailing functionality to datasheet 
...
Public Class frm_Main
    ...
    Private Sub compcalcForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'sets up a standard selection for the radio buttons
            ...
            If button = DialogResult.Yes Then
                ...
                If button3 = Windows.Forms.DialogResult.Yes Then
                    Do Until IsNumeric(prevbalLabel.Text) Or prevbalLabel.Text <> String.Empty
                        prevbalLabel.Text = InputBox("Please enter current balance or click 'Ok' to go to calculator.", title, "0.0")
    ...
    Public Sub ApplyCalculations()
        ...
        If button3 = Windows.Forms.DialogResult.Yes Then
            ...
            Else : My.Computer.FileSystem.CreateDirectory("C:\Comptime")
                My.Computer.FileSystem.WriteAllText(path1, line, False)
                My.Computer.FileSystem.WriteAllText(path2 & "comptimerun.txt", heading & ControlChars.NewLine _
    ...
    Private Sub btn_ClearData_Click(sender As System.Object, e As System.EventArgs) Handles btn_ClearData.Click
        'Me.Hide()
        'frm_Reconcillation.Show()
